module Logic.Asset.FX.Projectile exposing (Projectile, Setting, draw, empty, emptyWith, update, updateWith)

import AltMath.Vector2 as Vec2 exposing (Vec2)
import Logic.Asset.FX.P16 as P16
import Logic.Asset.FX.Particle as Particle exposing (Emitter)
