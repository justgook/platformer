module Logic.Asset.FX.P16 exposing (Particles, empty, points, render, updateShaderData, vertexShader)
...
mat4 viewport = mat4((2.0 / widthRatio), 0, 0, 0, 0, 2, 0, 0, 0, 0, -1, 0, -1, -1, 0, 1);
...
void main() {
    ...
    gl_Position = viewport * move * vec4(data.xy, 0, 1.0);
    gl_PointSize = data.z;
}
    |]
